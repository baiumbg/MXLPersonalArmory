...
struct WardenClientRegion_t {
    DWORD cbAllocSize;              //0x00
    DWORD offsetFunc1;              //0x04
    DWORD offsetRelocAddressTable;  //0x08
    DWORD nRelocCount;              //0x0c
    DWORD offsetWardenSetup;        //0x10
    DWORD _2[2];
    DWORD offsetImportAddressTable; //0x1c
    DWORD nImportDllCount;          //0x20
    DWORD nSectionCount;            //0x24
};
...
struct WardenClient_t {
    WardenClientRegion_t* pWardenRegion; //0x00
    DWORD cbSize;                   //0x04
    DWORD nModuleCount;             //0x08
    DWORD param;                    //0x0c
    DWORD fnSetupWarden;            //0x10
};
